              ...
              <div className="row clearfix">
                ...
                <div className="contactinfo-block col-lg-4 col-md-4 col-sm-12">
                  <div className="inner-box cp-seprator wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                    <h4>Contact Info</h4>
                    <div className="text">Al Matar St, Doha Delights,
                      Near Souq Waqif, Doha 12345, Qatar<br />Email : ozlerdoner.qa@gmail.com</div>
                    <div className="more-link"> <Link to="tel:+97477111504">+974 7711 1504</Link></div>
                  </div>
                </div>
