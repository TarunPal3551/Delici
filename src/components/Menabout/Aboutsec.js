            ...
            <div className="about-block info-block col-xl-4 col-lg-4 col-md-12 col-sm-12">
              <div className="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                <ul className="info">
                  ...
                  <li><strong>Contact Us</strong><span className="address">Al Matar St, Doha Delights,
                    Near Souq Waqif, Doha 12345, Qatar</span> <Link to="tel:+(974) 7711 1504‬
">+(974) 7711 1504‬
                    </Link> <br /><Link to="mailto:reservation@restro.com">reservation@restro.com</Link></li>
                </ul>
              </div>
            </div>
