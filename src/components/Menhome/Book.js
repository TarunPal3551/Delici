      ...
      <section className="online-reservation inner-page">
        ...
        <div className="auto-container">
          <div className="title-box centered">
            ...
            <div className="text request-info">Booking request <Link to="#">+(974) 7711 1504‬
              ...
              <div className="row clearfix">
                ...
                <div className="info-col col-lg-4 col-md-12 col-sm-12">
                  <div className="inner">
                    ...
                    <div className="data">
                      <ul className="info">
                        <li><strong>Contact Us</strong><br />Restaurant St, Delicious City,<br /> London 9578, UK <br /> Call : +(974) 7711 1504‬
                          <br /> Email : booking@domainname.com </li>
            ...
            <div className="row clearfix">
              ...
              <div className="location-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div className="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                  ...
                  <h4>New York</h4>
                  <div className="text">Restaurant St, Delicious City, NY. <br /> +(974) 7711 1504‬
                    <br />booking@domainname.com</div>
              ...
              <div className="location-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div className="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                  ...
                  <h4>Dubai</h4>
                  <div className="text">520, Delicious City, Revenu Db.<br />+(974) 7711 1504‬
                    <br />booking@domainname.com</div>
                  <div className="more-link"><Link to="#">get direction</Link></div>
                </div>
              </div>
              ...
              <div className="location-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div className="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                  ...
                  <h4>Paris</h4>
                  <div className="text">589, Delicious Avenue PS.<br />+(974) 7711 1504‬
                    <br /> booking@domainname.com</div>
                  <div className="more-link"><Link to="#">get direction</Link></div>
                </div>
              </div>
              ...
              <div className="location-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div className="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="900ms">
                  ...
                  <h4>Toronto</h4>
                  <div className="text">Restaurant St, Delicious City, CA <br /> +(974) 7711 1504‬
                    <br /> booking@domainname.com</div>
                  <div className="more-link"><Link to="#">get direction</Link></div>
                </div>
              </div>
